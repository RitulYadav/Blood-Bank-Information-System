      ...
      <div class="form">
        <form action="" method="post">
          <div class="inputfield">
            ...
            <input type="text" class="input" pattern="[A-Za-z .]{3,30}" name="firstname" required>
          </div>
          <div class="inputfield">
            <label>Last Name</label>
            <input type="text" class="input" pattern="[A-Za-z .]{3,30}" name="lastname" required>
          </div>
          <div class="inputfield">
            <label>Father's Name</label>
            <input type="text" class="input" pattern="[A-Za-z .]{3,30}" name="fname" required>
          </div>
          <div class="inputfield">
          ...
          <div class="inputfield">
            <label>Country</label>
            <input type="text" class="input" name="country" pattern="[A-Za-z ]{3,30}" required>
          </div>
          <div class="inputfield">
            <label>Postal Code</label>
            <input type="text" class="input" name="postalcode" pattern="[0-9]{6}" required>
          </div>
