      ...
      <div class="wrapper">
        ...
        <div class="form">
          <div class="inputfield">
            ...
            <input type="text" name="firstname" pattern="[A-Za-z .]{3,30}" class="input" required>
          </div>
          <div class="inputfield">
            <label>Last Name</label>
            <input type="text" name="lastname" pattern="[A-Za-z .]{3,30}" class="input" required>
          </div>
          <div class="inputfield">
            <label>Father's Name</label>
            <input type="text" name="fname" pattern="[A-Za-z .]{3,30}" class="input" required>
          </div>
          <div class="inputfield">
          ...
          <div class="inputfield">
            ...
            <input type="text" name="mno" class="input" pattern="[6789][0-9]{9}" required>
          </div>
          <div class="inputfield">
            <label>Address</label>
          ...
          <div class="inputfield">
            <label>City</label>
            <input type="text" class="input" name="city" pattern="[A-Za-z ]{3,30}" required>
          </div>
          <div class="inputfield">
            <label>Country</label>
            <input type="text" name="country" class="input" pattern="[A-Za-z ]{3,30}" required>
          </div>
          <div class="inputfield">
            <label>Postal Code</label>
            <input type="text" name="postalcode" pattern="[0-9]{6}" class="input" required>
          </div>
